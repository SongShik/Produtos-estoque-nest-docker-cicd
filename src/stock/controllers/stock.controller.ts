...
import { z } from "zod";
import { ZodValidation } from "src/shared/pipe/zod-validation.pipe";
...
export class StockController {
    ...
    @UsePipes(new ZodValidation(createStockSchema))
    @Post()
    ...
    async updateStock(
        ...
        @Body(new ZodValidation(updateStockSchema)) { stock }: UpdateStock
    ){
